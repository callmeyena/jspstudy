...
public class BoardModifyService implements IBoardService {
	...
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {	// request에는 파라미터가 3개 들어있음(title, content, board_no)
		...
		System.out.println(updateResult == 1 ? "수정 성공" : "수정 실패");
